            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nim" id="nim" value="<?=$profil['nim'];?>"readonly>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="program_studi" id="program_studi"
                            value="<?=$profil['program_studi'];?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir"
                            value="<?=$profil['tanggal_lahir'];?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="agama" id="agama" class="form-control" required>
                            ...
                            <option value="Kristen Protestan" <?=$profil['agama']=='Kristen Protestan'?'selected':'';?>>Kristen Protestan</option>
                            <option value="Kristen Katholik" <?=$profil['agama']=='Kristen Katholik'?'selected':'';?>>Kristen Katholik</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="text-danger" style="font-size:10pt;">Biarkan kosong jika tidak ingin merubah password</span>
                    </div>
                </div>
                <div class="p-3 float-right">
                    <button type="submit" class="btn btn-success"><i class="fas fa-fw fa-save"></i>Simpan Perubahan</button>
                </div>
            </div>
        </form>
    </div>
