...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Perysaratan <?= isset($surat_byid['nama_syarat']); ?></h6>
    </div>
<div class="card-body">
    <div class="table-responsive">
        <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <form method="post" enctype="multipart/form-data" id="form<?=$row['idsurat_syarat'];?>">
                            ...
                            <td>
                                ...
                                <span class="text-danger" style="font-size:10pt;">Format file <b>.pdf .jpg .jpeg
                                        .png</b>,ukuran maksimal <b>1 MB</b></span>
                            </td>
                            <td>
            ...
            <form action="<?=base_url('pengajuan/send_ajuan');?>" method="post">
                <input type="hidden" name="pengajuan_surat_id" value="<?=$this->uri->segment(3);?>" >
                <button type="submit" class="btn btn-success float-right"><i class="fas fa-fw fa-paper-plane" ></i>Kirim Pengajuan</button>
            </form>
        </div>
    </div>
</div>