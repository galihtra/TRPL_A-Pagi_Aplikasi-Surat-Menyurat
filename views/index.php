        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-icon rotate-n-10">
                    <sup><img src="<?=base_url('assets/img/logo.png');?>" alt="Logo" width="35" height=""></sup>
                </div>
                <div> <i style="font-size: 1.225rem;">PACE IF</i> </div>
            </a>
            ...
            <li class="nav-item <?=isset($pengajuan_surat)?'active':'';?>">
                <a class="nav-link" href="<?=base_url('pengajuan');?>">
                    ...
                    <span>Pengajuan Mahasiswa</span></a>
            </li>
            <?php endif; ?>

            <?php if(__session('level')=='user'): ?>
            <!-- Heading -->
            <div class="sidebar-heading">
                Menu Mahasiswa
            </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-lg-inline text-black-50 small"><?= strtoupper(__session('username')); ?></span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-black-50"></i>
                                    Logout
                                </a>
                            </div>
                        </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span> Copyright © Polibatam Software Correspondence <?= date('Y'); ?> | Created by Kelompok 2</a>
                        </span>
                    </div>
                </div>
            </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger btn-sm" href="<?=base_url('auth/logout');?>"><i
                            class="fas fa-sign-out-alt"></i> Iya,Keluar</a>
                </div>
            </div>
        </div>
    </div>
