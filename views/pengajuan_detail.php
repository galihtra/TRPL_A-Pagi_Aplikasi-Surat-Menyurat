...
<div class="card shadow mb-4">
    <div class="p-3">
        ...
        <?php endif; ?>
        <a href="<?=base_url('pengajuan/tolak/'.$ajuan_byid['idpengajuansurat']);?>"
    ...
    <div class="card-body">
        <table class="table">
            ...
            <tr>
                <td>Program Studi</td>
                <td>:</td>
                <td><?= $ajuan_byid['program_studi']; ?></td>
            </tr>
            <tr>
                <td>Tanggal Lahir</td>
                <td>:</td>
                <td><?= $ajuan_byid['tanggal_lahir']; ?></td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php elseif($ajuan_byid['status']=='Tolak'): ?>
                    <span class="badge badge-danger"><?= $ajuan_byid['status']; ?></span>
