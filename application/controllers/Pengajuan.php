...
class Pengajuan extends CI_Controller {
    ...
    public function create_ajuan(){
        ...
        $this->session->set_flashdata('success','silahkan unggah berkas persyaratan yang dibutuhkan');
    ...
    public function tolak($id){
        ...
        $this->session->set_flashdata('success','Status pengajuan berhasil ditolak');
    ...
    public function delete($id){
        if(check_id('pengajuan_surat','user_id',$id)==0){
            $this->pengajuan_m->hapus($id);
            $this->session->set_flashdata('success','Data Pengajuan berhasil di hapus');
        }else{
